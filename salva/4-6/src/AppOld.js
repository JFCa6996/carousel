      ...
      datos: [
        {
          ...
          text2: "renowned for her dynamic and captivating", // Texto asociado a la segunda imagen
          text3: "performances. Her vibrant style not only energizes the\n",  // Texto asociado a la tercera imagen
          text4: "Crowd and fills the dance floor but also adds a touch\n", // Texto asociado a la primera imagen
          text5: "of elegance and emotion to an event, especialy", // Texto asociado a la segunda imagen
          text6: "during heartfelt renditions of romantic ballads", // Texto asociado a la primera imagen
