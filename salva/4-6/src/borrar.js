    ...
    return (
        ...
        <div className="main_container">                                                                {/*Contenedor principal*/}
            ...
            <div className="menuButton">
                <MenuButton artistasSinFiltro={artistasSinFiltro}   />
            </div>
...
const MenuButton = ({ artistasSinFiltro  }) => {
    ...
    const renderComponent = () => {
        switch (selectedOption) {
            case 'HOME':
                return <FiltroArtistas artistasPorFiltrar={artistasSinFiltro} />;
            case 'SERVICIOS':
...
const FiltroArtistas = ({ artistasPorFiltrar, handleFiltrado }) => {
    const [filtroCampo, setFiltroCampo] = useState('my_formato'); // Campo inicial de filtro
    const [filtroValor, setFiltroValor] = useState('Solista'); // Valor inicial de filtro
    ...
    const valoresUnicos = [...new Set(artistasPorFiltrar.map(artista => artista.datas_h.map(seccion => seccion.datas_b.map(datos => datos[filtroCampo]))).flat())];
